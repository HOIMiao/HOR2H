...
def plot_pose2d(img, outputs, idx, fig_config, subplot_id, plot_txt, center=None, dataset_name='h2o3d'):
...
def load_faces():
    ...
    mano_layer = ManoLayer(mano_root='utils/manopth/mano/models', use_pca=False, ncomps=6, flat_hand_mean=True)
    ...
    mano_layer = ManoLayer(mano_root='utils/manopth/mano/models', side='left', use_pca=False, ncomps=6, flat_hand_mean=True)
