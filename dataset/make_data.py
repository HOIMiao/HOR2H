...
parser.add_argument("--YCBModelsDir", default='D:\Hand_Object_pose_shape\THOR-Net-ours\datasets\ycb_models', help="Path to YCB object meshes folder")
parser.add_argument("--dataset_path", default='D:\Hand_Object_pose_shape\THOR-Net-ours\datasets\ho3d_v2\data', help="Where to store dataset files")
