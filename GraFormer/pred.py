...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_path', type=str, default='/home2/HO3D_v3',
    ...
    parser.add_argument('--checkpoint_folder',
                        default='GTNet_V3_cheb_2l-21-gt-9/_head-4-layers-5-dim-96/_lr_step50000-lr_gamma0.9-drop_0.25',
    ...
    # define model
    model = GraFormer(adj=adj.cuda(1), hid_dim=args.dim_model, coords_dim=(2, 3), n_pts=21 * args.seq_length,
